...
int main(int argc, char** argv)	{
  ...
  if((newHandCnt % oldHandCnt) == 2){
    printf("Test Passed: Adventurer reveals 2 treasure cards and adds 2 cards to your hand.\nWe should have a handcount of 7. Handcount = : %d.\n", state.handCount[currentPlayer]);
  }
  else{
    printf("Test Failed: hand count is  %d.\n", state.handCount[currentPlayer]);
  }
