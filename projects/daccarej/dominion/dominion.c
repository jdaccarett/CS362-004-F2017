...
//**********************************************************************************************//
// CARD 2 SMITHY
// Description: its ability to increase your handsize by drawing 3 cards
...
//**********************************************************************************************//
//CARD 3 VILLAGE
// Description: is an Action card from the Base set. Village gives you +1 card from the deck and +2 actions
...
int village_card(int currentPlayer, struct gameState *state, int handPos, int i){
  ...
  //+2 Actions
  state->numActions = state->numActions + 1; //bug added to only + 1 action instead of 2.
